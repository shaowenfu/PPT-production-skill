...
DEFAULT_TEXT_RENDERING_SUFFIX = (
    " Text rendering constraints: render only the exact Chinese text explicitly specified in this prompt, without deleting, rewriting, paraphrasing, summarizing, adding, or expanding any text. Do not render any other visible text beyond the following content.; "
    ...
    "Do not render any markdown syntax, bullets, quote marks, dashes, or extra symbols; " \
    "line breaks must preserve whole words and intended phrases; never split a single word, or short fixed phrase across two lines; " \
)
